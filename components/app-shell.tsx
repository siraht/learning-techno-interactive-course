    ...
    <div className="site-shell">
      <aside className={`sidebar ${menuOpen ? "is-open" : ""}`}>
        ...
        <nav aria-label="Course navigation">
          {nav.map(([href, label, icon], index) => {
            ...
            return (
              <Link key={href} href={href} className={`nav-link ${active ? "is-active" : ""}`} onClick={() => setMenuOpen(false)}>
        ...
        <div className="sidebar-progress">
          ...
          <div className="progress-cells" aria-label={`${percent}% complete`}>
      ...
      <div className="main-frame">
        <header className="utility-header">
          <button className="mobile-menu" aria-label="Open navigation" onClick={() => setMenuOpen(true)}><Icon name="menu"/></button>
      ...
      {searchOpen && (
        <div className="modal-layer" role="dialog" aria-modal="true" aria-label="Search the course">
